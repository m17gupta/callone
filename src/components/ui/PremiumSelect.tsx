      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute left-0 right-0 z-[100] mt-2 overflow-hidden rounded-2xl border border-border/40 bg-[#111111] shadow-[0_20px_60px_rgba(0,0,0,0.3)] backdrop-blur-xl"
          >
            {searchable && (
