...
// ---------------------------------------------------------------------------
// GET  /api/admin/products/softgoods
// Query params: sku, brandId, page, limit
// ---------------------------------------------------------------------------
export async function GET(request: Request) {
    try {
        await dbConnect();
        const collection = mongoose.connection.db!.collection("product_softgoods");
        ...
        console.error("[softgoods] GET error:", error);
        return NextResponse.json(
            { error: error.message || "Failed to fetch SoftGood products", success: false },
            { status: 500 }
        );
    }
}
...
// ---------------------------------------------------------------------------
// POST  /api/admin/products/softgoods
// Body: SoftGoodInterface[]  — bulk upsert by sku
// ---------------------------------------------------------------------------
export async function POST(request: Request) {
    try {
        ...
        console.error("[softgoods] POST error:", error);
        return NextResponse.json(
            { error: error.message || "Failed to upsert SoftGood products", success: false },
            { status: 500 }
        );
    }
}
...
// ---------------------------------------------------------------------------
// PUT  /api/admin/products/softgoods
// Body: Partial<SoftGoodInterface>[]  or a single object (must include sku)
// ---------------------------------------------------------------------------
export async function PUT(request: Request) {
    try {
        ...
        console.error("[softgoods] PUT error:", error);
        return NextResponse.json(
            { error: error.message || "Failed to update SoftGood products", success: false },
            { status: 500 }
        );
    }
}
...
// ---------------------------------------------------------------------------
// DELETE  /api/admin/products/softgoods
...
export async function DELETE(request: Request) {
    try {
        ...
        console.error("[softgoods] DELETE error:", error);
        return NextResponse.json(
            { error: error.message || "Failed to delete SoftGood products", success: false },
            { status: 500 }
        );
    }
}
